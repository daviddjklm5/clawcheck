...
WITH seed_data(role_code, role_name, permission_level, sort_order) AS (
    VALUES
        ...
        ('YZH001', 'AD域管理', 'D类-普通', 58),
        ('YZH002', '短期驻场管理', 'D类-普通', 59),
        ('ZZ001', '组织/岗位查看', 'D类-普通', 60),
        ('DTX009', '业务数据提报', 'D类-普通', 61),
